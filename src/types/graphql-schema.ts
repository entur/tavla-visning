...
export type TBicycleOptimisationMethod = 'flat' | 'greenways' | 'quick' | 'safe' | 'triangle'
...
export type TBookingMethod = 'callDriver' | 'callOffice' | 'online' | 'phoneAtStop' | 'text'
...
export type TDirectionType = 'anticlockwise' | 'clockwise' | 'inbound' | 'outbound' | 'unknown'
...
export type TInterchangePriority = 'allowed' | 'notAllowed' | 'preferred' | 'recommended'
...
export type TServiceAlteration = 'cancellation' | 'extraJourney' | 'planned' | 'replaced'
...
export type TGetQuaysQueryVariables = Exact<{
	quayIds?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>
	whitelistedTransportModes?: InputMaybe<
		Array<InputMaybe<TTransportMode>> | InputMaybe<TTransportMode>
	>
	whitelistedLines?: InputMaybe<Array<Scalars['ID']['input']> | Scalars['ID']['input']>
