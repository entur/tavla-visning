/** biome-ignore-all lint/a11y/noSvgWithoutTitle: <comes later> */
import { ValidationErrorFilledIcon, ValidationExclamationCircleFilledIcon } from '@entur/icons'
...
export const DeviationIcon = ({ isHighlighted = true, deviationType }: DeviationIconProps) => {
	const size = '1.3em'
	...
	const color = deviationType === 'cancellation' ? 'var(--error-color)' : 'var(--warning-color)'
